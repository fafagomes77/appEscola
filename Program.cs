...
namespace AppCrudEscola
{
    public class Program
    {
        ...
        {
            Console.Write("Coloque o nome do aluno:");
            string nome = Console.ReadLine();
            Console.Write("Coloque a idade do aluno:");
            int idade = int.Parse(Console.ReadLine());
            Console.Write("Coloque o curso do aluno:");
            string curso = Console.ReadLine();
            Console.Write("Coloque a data de matrícula do aluno:");
            ...
            Console.Write("Aluno matriculado com êxito!\n");
        }

        static void Listar()
        {
            Console.Write("Informe o curso que deseja listar os alunos :");
        ...
        {
            Console.WriteLine("´Coloque o Id do aluno que deseja atualizar a matricula:");
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlDataReader reader = cmd.ExecuteReader())
                {
                    if (reader.Read())
                    {
                        Console.Write("Coloque a data de matrícula atualizada do aluno:");
